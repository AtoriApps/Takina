...
import lib.takina.core.xml.element
import lib.takina.core.xmpp.nextUIDLongs
...
class SDP(val id: String, val contents: List<Content>, val bundle: List<String>) {
	...
	companion object {
		...
		val log = LoggerFactory.logger("lib.takina.core.xmpp.modules.jingle.SDP")
...
fun Content.Companion.parse(sdp: String, creatorProvider: (String) -> Content.Creator, localRole: Content.Creator): Content {
	val log = LoggerFactory.logger("lib.takina.core.xmpp.modules.jingle.Content")
