...
import lib.takina.core.xml.element
import lib.takina.core.xml.getChildContent
...
import lib.takina.core.xmpp.modules.mam.ForwardedStanza
import lib.takina.core.xmpp.modules.mam.MAMModule
import lib.takina.core.xmpp.modules.pubsub.Affiliation
import lib.takina.core.xmpp.modules.pubsub.PubSubItemEvent
import lib.takina.core.xmpp.modules.pubsub.PubSubModule
import lib.takina.core.xmpp.modules.roster.RosterItemAnnotation
import lib.takina.core.xmpp.modules.roster.RosterItemAnnotationProcessor
...
data class MIXMessageEvent(val channel: BareJID, val stanza: Message, val timestamp: Instant) : Event(TYPE) {
	...
	companion object : EventDefinition<MIXMessageEvent> {
		...
		override val TYPE = "lib.takina.core.xmpp.modules.mix.MIXMessageEvent"
	}
}
...
sealed class MixParticipantEvent(val channel: BareJID, val id: String): Event(TYPE) {
	...
	companion object : EventDefinition<MixParticipantEvent> {
		...
		override val TYPE = "lib.takina.core.xmpp.modules.mix.MixParticipantEventReceived"
	}
}
...
class MIXModule(
	...
	private fun myJID(): FullJID = context.boundJID ?: throw TakinaException("Resource not bound.")
