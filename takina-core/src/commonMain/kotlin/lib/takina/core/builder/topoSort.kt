...
inline fun Iterable<Item<out TakinaModule, out Any>>.extendForDependencies(): List<Item<out TakinaModule, out Any>> {

	val result = mutableSetOf<Item<out TakinaModule, out Any>>()
	result.addAll(this)
