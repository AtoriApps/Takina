...
class SASLScramSHATest {
    ...
    fun test_first_message_with_authcid() {
        ...
        assertEquals(
            ...
            scram.evaluateChallenge(null, DummyTakina(), configuration, context)!!
                .fromBase64()
                .decodeToString(),
    ...
    fun test_messages_sha1() {
        ...
        assertNull(
            scram.evaluateChallenge(
                "v=rmF9pqV8S7suAoZWja4dJRkFsKQ=".encodeToByteArray().toBase64(), DummyTakina(), configuration, context
            )
        )
