...
import lib.takina.core.connector.ChannelBindingDataProvider
...
class DefaultTLSProcessor(private val socket: Socket, private val config: SocketConnectorConfig) : TLSProcessor,
	...
	private val log = LoggerFactory.logger("lib.takina.core.connector.socket.JavaXTLSProcessor")
...
fun calculateCertificateHash(certificate: X509Certificate): ByteArray? {
	val log = LoggerFactory.logger("lib.takina.core.connector.socket.calculateCertificateHash")
	return try {
