...
sealed class RosterEvent(
	...
	companion object : EventDefinition<RosterEvent> {
		...
		override val TYPE = "lib.takina.core.xmpp.modules.roster.RosterEvent"
	}
...
class RosterLoadedEvent : Event(TYPE) {
	...
	companion object : EventDefinition<RosterLoadedEvent> {
		...
		override val TYPE = "lib.takina.core.xmpp.modules.roster.RosterLoadedEvent"
	}
...
class RosterUpdatedEvent : Event(TYPE) {
	...
	companion object : EventDefinition<RosterUpdatedEvent> {
		...
		override val TYPE = "lib.takina.core.xmpp.modules.roster.RosterUpdatedEvent"
	}
...
class RosterModule(context: Context) : RosterModuleConfiguration, AbstractXmppIQModule(
	...
	private val log = LoggerFactory.logger("lib.takina.core.xmpp.modules.roster.RosterModule")
...
//		}
	...
	override fun processSet(element: IQ) {
		val boundJID =
			context.boundJID ?: throw TakinaException("Session is not bound. Cannot process roster request.")
