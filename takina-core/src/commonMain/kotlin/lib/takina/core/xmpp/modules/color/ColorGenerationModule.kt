 ...
 *
 */
class ColorGenerationModule(override val context: Context) : ColorGeneratorEngine(), TakinaModule {
	 ...
	 *
	 */
	companion object : TakinaModuleProvider<ColorGenerationModule, ColorGenerationModuleConfig> {
