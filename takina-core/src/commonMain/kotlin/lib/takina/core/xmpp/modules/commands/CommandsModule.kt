...
class CommandsModule(override val context: Context, private val discoveryModule: DiscoveryModule) : XmppModule,
	...
	private class AdHocRequestImpl(
		...
		override fun getSession(): AdHocSession {
			...
			return adHocSession ?: throw TakinaException("Internal error. AdHoc Session is not created.")
		}
	...
	override fun process(element: Element) {
		...
		val cmdElement = stanza.getChildrenNS("command", XMLNS) ?: throw TakinaException("Command element is missing")
		val nodeName =
